...
NUM_WORKERS = 1
CHECKPOINT_GENERATION_INTERVAL = 5
...
def _parse_args():
    ...
    parser.add_argument('--generate_plots', dest='generate_plots', default=True, action='store_true')
    ...
    parser.add_argument('--render_tests', dest='render_tests', default=True, action='store_true')
